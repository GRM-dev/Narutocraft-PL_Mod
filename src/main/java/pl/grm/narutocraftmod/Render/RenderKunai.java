...
public class RenderKunai extends Render {
	...
	public void doRender(Entity par1EntityKunai, double var2, double var4, double var6,
		 ...
		 GL11.glRotatef(par1EntityKunai.prevRotationYaw + (par1EntityKunai.rotationYaw - par1EntityKunai.prevRotationYaw) * var9 - 90.0F, 0.0F, 1.0F, 0.0F);
		 GL11.glRotatef(par1EntityKunai.prevRotationPitch + (par1EntityKunai.rotationPitch - par1EntityKunai.prevRotationPitch) * var9, 0.0F, 0.0F, 1.0F);
		 ...
		 float f10 = 0.05625F;
		 GL11.glEnable(GL12.GL_RESCALE_NORMAL);
		 float f11 = /*(float)par1EntityKunai.arrowShake*/0 - var9;
		 int red = 220;
		 int green = 10;
		 int blue = 10;
		 int alpha = 120;
