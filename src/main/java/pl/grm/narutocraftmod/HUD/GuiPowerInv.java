...
public class GuiPowerInv extends GuiContainer{
	...
	private static final ResourceLocation iconLocation = new ResourceLocation("narutocraftmod:textures/gui/custom_inventory.png");
	private final InvPlayerSlot inventory;

	public GuiPowerInv(EntityPlayer player, InventoryPlayer inventoryPlayer, InvPlayerSlot inventoryCustom)
	{
