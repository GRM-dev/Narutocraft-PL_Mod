...
public class RegArmor extends RegItems {
	...
	public static final ItemArmor	plateIwa		= (ItemArmor) (new NCPLItemArmor(Iwa,
															4, 1, "IwaArmor"))
															.setUnlocalizedName("plateIwa");
	public static final ItemArmor	legsIwa			= (ItemArmor) (new NCPLItemArmor(Iwa,
															4, 2, "IwaArmor"))
															.setUnlocalizedName("legginsIwa");
	public static final ItemArmor	bootsIwa		= (ItemArmor) (new NCPLItemArmor(Iwa,
															4, 3, "IwaArmor"))
															.setUnlocalizedName("bootsIwa");
	
	public static final ItemArmor	plateKonoha		= (ItemArmor) (new NCPLItemArmor(
															Konoha, 4, 1, "Konoha"))
															.setUnlocalizedName("plateKonoha");
	public static final ItemArmor	legsKonoha		= (ItemArmor) (new NCPLItemArmor(
															Konoha, 4, 2, "Konoha"))
															.setUnlocalizedName("legginsKonoha");
	public static final ItemArmor	bootsKonoha		= (ItemArmor) (new NCPLItemArmor(
															Konoha, 4, 3, "Konoha"))
															.setUnlocalizedName("bootsKonoha");
	public static final ItemArmor	plateOto		= (ItemArmor) (new NCPLItemArmor(Oto,
															4, 1, "OtoArmor"))
															.setUnlocalizedName("plateOto");
	public static final ItemArmor	legsOto			= (ItemArmor) (new NCPLItemArmor(Oto,
															4, 2, "OtoArmor"))
															.setUnlocalizedName("legginsOto");
	public static final ItemArmor	bootsOto		= (ItemArmor) (new NCPLItemArmor(Oto,
															4, 3, "OtoArmor"))
															.setUnlocalizedName("bootsOto");
	public static final ItemArmor	plateOld		= (ItemArmor) (new NCPLItemArmor(Old,
															4, 1, "PrzodkowArmor"))
															.setUnlocalizedName("plateOld");
	public static final ItemArmor	legsOld			= (ItemArmor) (new NCPLItemArmor(Old,
															4, 2, "PrzodkowArmor"))
															.setUnlocalizedName("legginsOld");
	public static final ItemArmor	bootsOld		= (ItemArmor) (new NCPLItemArmor(Old,
															4, 3, "PrzodkowArmor"))
															.setUnlocalizedName("bootsOld");
	public static final ItemArmor	plateKumo		= (ItemArmor) (new NCPLItemArmor(
															Kumo, 4, 1, "KumoArmor"))
															.setUnlocalizedName("plateKumo");
	public static final ItemArmor	legsKumo		= (ItemArmor) (new NCPLItemArmor(
															Kumo, 4, 2, "KumoArmor"))
															.setUnlocalizedName("legginsKumo");
	public static final ItemArmor	bootsKumo		= (ItemArmor) (new NCPLItemArmor(
															Kumo, 4, 3, "KumoArmor"))
															.setUnlocalizedName("bootsKumo");
	public static final ItemArmor	helmetRyu		= (ItemArmor) (new NCPLItemArmor(
															Ryuu, 4, 0, "RyuArmor"))
															.setUnlocalizedName("helmetRyuu");
	public static final ItemArmor	plateRyu		= (ItemArmor) (new NCPLItemArmor(
															Ryuu, 4, 1, "RyuArmor"))
															.setUnlocalizedName("plateRyuu");
	public static final ItemArmor	legsRyu			= (ItemArmor) (new NCPLItemArmor(
															Ryuu, 4, 2, "RyuArmor"))
															.setUnlocalizedName("legginsRyuu");
	public static final ItemArmor	bootsRyu		= (ItemArmor) (new NCPLItemArmor(
															Ryuu, 4, 3, "RyuArmor"))
