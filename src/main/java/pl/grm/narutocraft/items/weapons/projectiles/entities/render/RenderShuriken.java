...
public class RenderShuriken extends Render {
	...
	final ResourceLocation texture = new ResourceLocation(References.ModTexturePath + "models/obj/Shuriken.png");
	final ResourceLocation modelobj = new ResourceLocation(References.ModTexturePath + "models/obj/Shuriken.obj");
	...
	public void doRender(Entity par1EntityShuriken, double var2, double var4, double var6, float var8, float var9) {
		...
		GL11.glRotatef(
				...
				0.0F, 1.0F, 0.0F);
		GL11.glRotatef(par1EntityShuriken.prevRotationPitch
				+ ((par1EntityShuriken.rotationPitch - par1EntityShuriken.prevRotationPitch) * var9), 0.0F, 0.0F, 1.0F);
		GL11.glEnable(32826);
