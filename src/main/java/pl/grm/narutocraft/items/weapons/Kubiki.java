...
public class Kubiki extends SwordMain {
	...
	public void addInformation(ItemStack par1ItemStack,
		...
		par3List.add("Blood from foes stored: "
				+ UtilityNBTHelper.getInt(par1ItemStack, References.ModTag
						+ "kBlood"));
	}
	...
	public void onUpdate(ItemStack par1ItemStack, World par2World,
		...
		if ((par2World.getWorldTime() % 65) == 0) {
			int storedBlood = UtilityNBTHelper.getInt(par1ItemStack,
					References.ModTag + "kBlood");
			if (storedBlood >= 3) {
				if (par1ItemStack.isItemDamaged()) {
					par1ItemStack
							.setItemDamage(par1ItemStack.getItemDamage() - 1);
					storedBlood -= 3;
					UtilityNBTHelper.setInteger(par1ItemStack,
							References.ModTag + "kBlood", storedBlood);
				}
			}
		}
	}
