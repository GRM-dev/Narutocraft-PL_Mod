...
public class ItemEffect
{
    ...
    public ItemEffect(int par1, int par2)
    {
        this(par1, par2, 0);
    }

    public ItemEffect(int par1, int par2, int par3)
    {
        this(par1, par2, par3, false);
    }

    public ItemEffect(int par1, int par2, int par3, boolean par4)
    {
        this.potionID = par1;
        this.duration = par2;
        this.amplifier = par3;
    ...
    public ItemEffect(ItemEffect par1PotionEffect)
    {
    ...
    public boolean equals(Object par1Obj)
    {
        ...
        {
            ItemEffect potioneffect = (ItemEffect)par1Obj;
     ...
     */
    public static ItemEffect readCustomPotionEffectFromNBT(NBTTagCompound par0NBTTagCompound)
    {
