...
public class SkillTreeManager {
	...
	public void RegisterEntry(IJutsu jutsu, int x, int y, SkillTrees tree,
		...
		ArrayList<SkillTreeEntry> treeListing = tree == SkillTrees.NINJUTSU
				? this.fuuinjutsuTree
		...
		SkillTreeEntry newEntry = new SkillTreeEntry(
				...
				y,
				tree,
				locatedPrerequisites
						.toArray(new SkillTreeEntry[locatedPrerequisites.size()]),
				jutsu, enabled);
	...
	public ArrayList<SkillTreeEntry> getTree(SkillTrees tree) {
		...
		switch (tree.ordinal()) {
			case 1 :
				safeCopy.addAll(this.genjutsuTree);
				break;
			case 2 :
				safeCopy.addAll(this.ninjutsuTree);
				break;
			case 3 :
				safeCopy.addAll(this.fuuinjutsuTree);
				break;
			case 4 :
				safeCopy.addAll(this.taijutsuTree);
		}
		return safeCopy;
	}
	...
	public int[] getDisabledSkillIDs() {
		...
		for (SkillTreeEntry entry : this.ninjutsuTree) {
			if (!entry.enabled) {
				disableds.add(Integer.valueOf(JutsuManager.instance
		...
		for (int i = 0; i < disableds.size(); i++) {
			toReturn[i] = disableds.get(i).intValue();
		}
		return toReturn;
	}
	...
	public void init() {
		...
		// RegisterPart(JutsuManager.instance.getJutsu("Projectile"), 300, 45,
		// SkillTrees.Offense, TreePointTypes.BLUE, new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("PhysicalDamage"), 300,
		// 90,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Projectile")});
		// RegisterPart(JutsuManager.instance.getJutsu("Gravity"), 255, 70,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Projectile")});
		// RegisterPart(JutsuManager.instance.getJutsu("Bounce"), 345, 70,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Projectile")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("FireDamage"), 210, 135,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("PhysicalDamage")});
		// RegisterPart(JutsuManager.instance.getJutsu("LightningDamage"), 255,
		// 135, SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("FireDamage")});
		// RegisterPart(JutsuManager.instance.getJutsu("Ignition"), 165, 135,
		...
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Ignition")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("MagicDamage"), 390, 135,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("PhysicalDamage")});
		// RegisterPart(JutsuManager.instance.getJutsu("FrostDamage"), 345, 135,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("MagicDamage")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Drown"), 435, 135,
		// SkillTrees.Offense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("MagicDamage")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Blind"), 233, 180,
		...
		// RegisterPart(JutsuManager.instance.getJutsu("AoE"), 300, 180,
		// SkillTrees.Offense, TreePointTypes.GREEN, new SkillTreeEntry[]{
		...
		// RegisterPart(JutsuManager.instance.getJutsu("Freeze"), 345, 180,
		// SkillTrees.Offense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("FrostDamage")});
		// RegisterPart(JutsuManager.instance.getJutsu("Knockback"), 390, 180,
		// SkillTrees.Offense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("MagicDamage")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Solar"), 210, 225,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Blind")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Storm"), 255, 225,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		...
		// JutsuManager.instance.getJutsu("MagicDamage"),
		// JutsuManager.instance.getJutsu("FrostDamage")});
		// RegisterPart(JutsuManager.instance.getJutsu("Silence"), 345, 245,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("AstralDistortion")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Fling"), 390, 245,
		// SkillTrees.Offense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Knockback")});
		// RegisterPart(JutsuManager.instance.getJutsu("VelocityAdded"), 390,
		// 290,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Fling")});
		// RegisterPart(JutsuManager.instance.getJutsu("WateryGrave"), 435, 245,
		// SkillTrees.Offense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Drown")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Piercing"), 323, 215,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Freeze")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Beam"), 300, 270,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("AoE")});
		// RegisterPart(JutsuManager.instance.getJutsu("Damage"), 300, 315,
		// SkillTrees.Offense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Beam")});
		// RegisterPart(JutsuManager.instance.getJutsu("Fury"), 255, 315,
		...
		// RegisterPart(JutsuManager.instance.getJutsu("Wave"), 367, 315,
		// SkillTrees.Offense, TreePointTypes.RED, new SkillTreeEntry[]{
		// JutsuManager.instance.getJutsu("Beam"),
		// JutsuManager.instance.getJutsu("Fling")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Blizzard"), 75, 45,
		// SkillTrees.Offense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("FallingStar"), 75, 90,
		// SkillTrees.Offense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("FireRain"), 75, 135,
		// SkillTrees.Offense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("Dismembering"), 75, 180,
		// SkillTrees.Offense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		//
		// this.defenseTree.clear();
		// RegisterPart(JutsuManager.instance.getJutsu("Self"), 267, 45,
		// SkillTrees.Defense, TreePointTypes.BLUE, new SkillTreeEntry[0]);
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Leap"), 222, 90,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Self")});
		// RegisterPart(JutsuManager.instance.getJutsu("Regeneration"), 357, 90,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Self")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Shrink"), 402, 90,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Regeneration")});
		// RegisterPart(JutsuManager.instance.getJutsu("Slowfall"), 222, 135,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Leap")});
		// RegisterPart(JutsuManager.instance.getJutsu("Heal"), 357, 135,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Regeneration")});
		// RegisterPart(JutsuManager.instance.getJutsu("LifeTap"), 312, 135,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Heal")});
		// RegisterPart(JutsuManager.instance.getJutsu("Healing"), 402, 135,
		// SkillTrees.Defense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Heal")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Summon"), 267, 135,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("LifeTap")});
		// RegisterPart(JutsuManager.instance.getJutsu("Contingency_Damage"),
		// 447,
		...
		// TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Slowfall")});
		// RegisterPart(JutsuManager.instance.getJutsu("LifeDrain"), 312, 180,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("LifeTap")});
		// RegisterPart(JutsuManager.instance.getJutsu("Dispel"), 357, 180,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Heal")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Contingency_Fall"), 267,
		// 180, SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("GravityWell")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("SwiftSwim"), 177, 200,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Haste")});
		// RegisterPart(JutsuManager.instance.getJutsu("Repel"), 132, 200,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Slow")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Levitate"), 222, 225,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("GravityWell")});
		// RegisterPart(JutsuManager.instance.getJutsu("ManaDrain"), 312, 225,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("LifeDrain")});
		// RegisterPart(JutsuManager.instance.getJutsu("Zone"), 357, 225,
		// SkillTrees.Defense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Dispel")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Wall"), 87, 200,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Repel")});
		// RegisterPart(JutsuManager.instance.getJutsu("Accelerate"), 177, 245,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("SwiftSwim")});
		// RegisterPart(JutsuManager.instance.getJutsu("Entangle"), 132, 245,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Repel")});
		// RegisterPart(
		...
		// RegisterPart(JutsuManager.instance.getJutsu("Shield"), 357, 270,
		// SkillTrees.Defense, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Zone")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Contingency_Health"),
		// 402,
		// 270, SkillTrees.Defense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Shield")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Rune"), 157, 315,
		...
		//
		// RegisterPart(JutsuManager.instance.getJutsu("RuneProcs"), 157, 360,
		// SkillTrees.Defense, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Rune")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Speed"), 202, 315,
		// SkillTrees.Defense, TreePointTypes.RED, new SkillTreeEntry[]{
		// JutsuManager.instance.getJutsu("Accelerate"),
		// JutsuManager.instance.getJutsu("Flight")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Reflect"), 357, 315,
		// SkillTrees.Defense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Shield")});
		// RegisterPart(JutsuManager.instance.getJutsu("ChronoAnchor"), 312,
		// 315,
		// SkillTrees.Defense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Reflect")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Duration"), 312, 360,
		// SkillTrees.Defense, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("ChronoAnchor")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("ManaLink"), 30, 45,
		// SkillTrees.Defense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("ManaShield"), 30, 90,
		// SkillTrees.Defense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("BuffPower"), 30, 135,
		// SkillTrees.Defense, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		//
		// this.utilityTree.clear();
		// RegisterPart(JutsuManager.instance.getJutsu("Touch"), 275, 75,
		// SkillTrees.Utility, TreePointTypes.BLUE, new SkillTreeEntry[0]);
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Dig"), 275, 120,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Touch")});
		// RegisterPart(JutsuManager.instance.getJutsu("WizardsAutumn"), 315,
		// 120,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Dig")});
		// RegisterPart(JutsuManager.instance.getJutsu("TargetNonSolid"), 230,
		// 75,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Touch")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("PlaceBlock"), 185, 93,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Dig")});
		// RegisterPart(JutsuManager.instance.getJutsu("FeatherTouch"), 230,
		// 137,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Dig")});
		// RegisterPart(JutsuManager.instance.getJutsu("MiningPower"), 185, 137,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("FeatherTouch")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Light"), 275, 165,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Dig")});
		// RegisterPart(JutsuManager.instance.getJutsu("NightVision"), 185, 165,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Light")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Binding"), 275, 210,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Light")});
		// RegisterPart(JutsuManager.instance.getJutsu("Disarm"), 230, 210,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("Charm"), 315, 235,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("TrueSight"), 185, 210,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("NightVision")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Lunar"), 145, 210,
		// SkillTrees.Utility, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("TrueSight")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("HarvestPlants"), 365,
		// 120,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("Plow"), 365, 165,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("Plant"), 365, 210,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("CreateWater"), 365, 255,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("Drought"), 365, 300,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("BanishRain"), 365, 345,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Drought")});
		// RegisterPart(JutsuManager.instance.getJutsu("WaterBreathing"), 410,
		// 345, SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Drought")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Grow"), 410, 210,
		...
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Chain"), 455, 210,
		// SkillTrees.Utility, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Grow")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Rift"), 275, 255,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Binding")});
		// RegisterPart(JutsuManager.instance.getJutsu("Invisibility"), 185,
		// 255,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("TrueSight")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("RandomTeleport"), 185,
		// 300, SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Invisibility")});
		// RegisterPart(JutsuManager.instance.getJutsu("Attract"), 245, 300,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Rift")});
		// RegisterPart(JutsuManager.instance.getJutsu("Telekinesis"), 305, 300,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Rift")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Blink"), 185, 345,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("RandomTeleport")});
		// RegisterPart(JutsuManager.instance.getJutsu("Range"), 140, 345,
		// SkillTrees.Utility, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Blink")});
		// RegisterPart(JutsuManager.instance.getJutsu("Channel"), 275, 345,
		...
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Radius"), 275, 390,
		// SkillTrees.Utility, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Channel")});
		// RegisterPart(JutsuManager.instance.getJutsu("Transplace"), 185, 390,
		// SkillTrees.Utility, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Blink")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Mark"), 155, 435,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Transplace")});
		// RegisterPart(JutsuManager.instance.getJutsu("Recall"), 215, 435,
		// SkillTrees.Utility, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("Transplace")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("DivineIntervention"),
		// 172,
		...
		// RegisterPart(JutsuManager.instance.getJutsu("EnderIntervention"),
		// 198,
		// 480, SkillTrees.Utility, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance.getJutsu("Recall"),
		// JutsuManager.instance.getJutsu("Mark")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Contingency_Death"),
		// 198,
		// 524, SkillTrees.Utility, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("EnderIntervention")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("Daylight"), 75, 45,
		// SkillTrees.Utility, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("Moonrise"), 75, 90,
		// SkillTrees.Utility, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("Prosperity"), 75, 135,
		// SkillTrees.Utility, TreePointTypes.SILVER,
		// new SkillTreeEntry[0]);
		//
		// RegisterPart(JutsuManager.instance.getJutsu("ManaRegenI"), 275, 75,
		// SkillTrees.Talents, TreePointTypes.BLUE, new SkillTreeEntry[0]);
		// RegisterPart(JutsuManager.instance.getJutsu("Colour"), 230, 75,
		// SkillTrees.Talents, TreePointTypes.BLUE, new SkillTreeEntry[0]);
		//
		// RegisterPart(JutsuManager.instance.getJutsu("AffinityGains"), 365,
		// 120,
		// SkillTrees.Talents, TreePointTypes.BLUE,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("ManaRegenI")});
		// RegisterPart(JutsuManager.instance.getJutsu("ManaRegenII"), 275, 120,
		// SkillTrees.Talents, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("ManaRegenI")});
		// RegisterPart(JutsuManager.instance.getJutsu("SpellMotion"), 230, 120,
		// SkillTrees.Talents, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("ManaRegenII")});
		// RegisterPart(JutsuManager.instance.getJutsu("AugmentedCasting"), 230,
		// 165, SkillTrees.Talents, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("SpellMotion")});
		// RegisterPart(JutsuManager.instance.getJutsu("ManaRegenIII"), 275,
		// 165,
		// SkillTrees.Talents, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("ManaRegenII")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("ExtraSummon"), 230, 210,
		// SkillTrees.Talents, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("AugmentedCasting")});
		//
		// RegisterPart(JutsuManager.instance.getJutsu("MageBandI"), 320, 120,
		// SkillTrees.Talents, TreePointTypes.GREEN,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("ManaRegenI")});
		// RegisterPart(JutsuManager.instance.getJutsu("MageBandII"), 320, 165,
		// SkillTrees.Talents, TreePointTypes.RED,
		// new SkillTreeEntry[]{JutsuManager.instance
		// .getJutsu("MageBandI")});
