...
public enum Elements {
	NONE(0, new Color(0x000000)),
	KATON(1, new Color(0xFF0000)),
	FUUTON(2, new Color(0x00FF80)),
	RAITON(3, new Color(0xFFFF00)),
	DOTON(4, new Color(0xFF8000)),
	SUITON(5, new Color(0x0080FF));
