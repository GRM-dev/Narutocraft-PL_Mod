...
public class RegEntities extends NarutoCraft {
	public static void RegEntitiesList() {
    	int id =0;
    	EntityRegistry.registerModEntity(EntityKunai.class, "Kunai", id, NarutoCraft.instance, 80, 1, true); id++;
    	EntityRegistry.registerModEntity(EntityWKunai.class, "WKunai", id, NarutoCraft.instance, 80, 1, true); id++;
    	...
    	EntityRegistry.registerModEntity(EntityKyuubi.class, "Kyuubi", id, NarutoCraft.instance, 80, 1, true); id++;
