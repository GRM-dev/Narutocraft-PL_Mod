...
public class DataReader {
	...
	public DataReader(byte[] data, boolean getID) {
		...
		if (getID) {
			try {
				...
				FMLLog.severe("DataReader (getID): " + e.toString(), new Object[0]);
				e.printStackTrace();
			}
		}
	}
	...
	public boolean getBoolean() {
		...
		try {
			...
			FMLLog.severe("DataReader (getBoolean): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
	...
	public byte getByte() {
		...
		try {
			...
			FMLLog.severe("DataReader (getByte): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
	...
	public double getDouble() {
		...
		try {
			...
			FMLLog.severe("DataReader (getDouble): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
	...
	public float getFloat() {
		...
		try {
			...
			FMLLog.severe("DataReader (getFloat): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
	...
	public int[] getIntArray() {
		try {
			...
			FMLLog.severe("DataReader (getIntArray): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return new int[0];
	}
	...
	public long getLong() {
		...
		try {
			...
			FMLLog.severe("DataReader (getLong): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
	...
	public short getShort() {
		...
		try {
			...
			FMLLog.severe("DataReader (getShort): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
	...
	public String getString() {
		...
		try {
			...
			FMLLog.severe("DataReader (getString): " + e.toString(), new Object[0]);
			e.printStackTrace();
		}
		return value;
	}
