 ...
 * @author Admaster
 */
public class RenderExplodeKunai extends RenderKunai {

	public RenderExplodeKunai() {
		super();
	}

	public RenderExplodeKunai(RenderManager renderManager) {
		super(renderManager);
	}

	@Override
	public void doRender(Entity par1EntityKunai, double var2, double var4, double var6, float var8, float var9) {
		super.doRender(par1EntityKunai, var2, var4, var6, var8, var9);
		// this.bindTexture(this.texture);
		// WorldRenderer modelRenderer =
		...
		// + ((par1EntityKunai.rotationPitch -
		// par1EntityKunai.prevRotationPitch) * var9),
		// 0.0F, 0.0F, 1.0F);
		// byte b0 = 0;
		// float f2 = 0.0F;
		// float f3 = 0.5F;
	...
	protected ResourceLocation getEntityTexture(Entity var1) {
		return new ResourceLocation(References.ModTexturePath + "textures/model/WKunai.png");
	}
