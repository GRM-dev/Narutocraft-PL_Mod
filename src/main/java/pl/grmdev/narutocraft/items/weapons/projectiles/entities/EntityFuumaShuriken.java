package pl.grmdev.narutocraft.items.weapons.projectiles.entities;
...
public class EntityFuumaShuriken extends EntityArrow implements IProjectile {
	...
	public EntityFuumaShuriken(World par1World) {
		super(par1World);
	 ...
	 *            z
	 */
	public EntityFuumaShuriken(World par1World, double par2, double par4, double par6) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityFuumaShuriken(World par1World, EntityLivingBase par2EntityLivingBase,
	...
	public EntityFuumaShuriken(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		if (!this.worldObj.isRemote && this.inGround) {
			...
			if ((this.canBePickedUp == 1)
					&& !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(RegItems.FuumaShuriken, 1))) {
				flag = false;
			}
