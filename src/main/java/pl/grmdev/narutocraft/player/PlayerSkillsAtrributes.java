...
public class PlayerSkillsAtrributes {
	...
	// Stats
	private int strength = 0, agility = 0, dexterity = 0, resistance = 0, elementPowerModifier = 0, chakraModifier = 0,
			chakraRegenBonus = 0, ninjaLevel = 1;

	private int currentNinjaXp = 0, ninjaXpLevelUpCap = 15;
	public int skillPoints = 0;
	private int skillTreeBukiLevel = 0, skillTreeFuuinLevel = 0, skillTreeGenLevel = 0, skillTreeIryoLevel = 0,
			skillTreeNinLevel = 0, skillTreeTaiLevel = 0;

	/** Returns an Int array of 17 elements **/
	public int[] getValues() {
		return new int[]{this.strength, this.agility, this.dexterity, this.resistance, this.elementPowerModifier,
				this.chakraModifier, this.chakraRegenBonus, this.ninjaLevel, this.currentNinjaXp,
				this.ninjaXpLevelUpCap, this.skillPoints, this.skillTreeBukiLevel, this.skillTreeFuuinLevel,
				this.skillTreeGenLevel, this.skillTreeIryoLevel, this.skillTreeNinLevel, this.skillTreeTaiLevel};
	}
	...
	/**
	 * Takes an Int Array of 17 elements Best used with getValues, harder to
	 * mess up
	 **/
