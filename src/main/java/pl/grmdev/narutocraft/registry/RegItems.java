...
import pl.grmdev.narutocraft.items.*;
import pl.grmdev.narutocraft.items.armor.NCPLItemArmor;
import pl.grmdev.narutocraft.items.food.*;
import pl.grmdev.narutocraft.items.weapons.*;
import pl.grmdev.narutocraft.items.weapons.projectiles.*;
